...
public:
	...
	HostArray3D();
	HostArray3D( int width, int height, int depth );
	HostArray3D( const Array3D< T >& src );
	virtual ~HostArray3D();
...
template< typename T >
HostArray3D< T >::HostArray3D( int width, int height, int depth ) :
...
template< typename T >
HostArray3D< T >::HostArray3D( const Array3D< T >& src ) :
...
template< typename T >
bool HostArray3D< T >::isNull() const
{
	return( m_pitchedPointer.ptr == NULL );
}

template< typename T >
bool HostArray3D< T >::notNull() const
{
	return( m_pitchedPointer.ptr != NULL );
}

template< typename T >
int HostArray3D< T >::width() const
{
	return m_width;
}

template< typename T >
int HostArray3D< T >::height() const
{
	return m_height;
}

template< typename T >
int HostArray3D< T >::depth() const
{
	return m_depth;
}

template< typename T >
int HostArray3D< T >::numElements() const
{
	return m_width * m_height;
}

template< typename T >
size_t HostArray3D< T >::rowPitch() const
{
	return m_pitchedPointer.pitch;
}

template< typename T >
size_t HostArray3D< T >::slicePitch() const
{
	return m_pitchedPointer.pitch * m_height;
}

template< typename T >
size_t HostArray3D< T >::sizeInBytes() const
{
	return m_sizeInBytes;
}

template< typename T >
void HostArray3D< T >::resize( int width, int height, int depth )
{
	if( width == m_width &&
		height == m_height &&
		depth == m_depth )
...
template< typename T >
void HostArray3D< T >::clear()
{
	CUDA_SAFE_CALL( cudaMemset3D( m_pitchedPointer, 0, m_extent ) );
}

template< typename T >
void HostArray3D< T >::copyFromHost( const Array3D< T >& src )
{
...
template< typename T >
void HostArray3D< T >::copyToHost( Array3D< T >& dst ) const
{
	cudaMemcpy3DParms params;
...
template< typename T >
HostArray3D< T >::operator cudaPitchedPtr() const
{
	return m_pitchedPointer;
}

template< typename T >
cudaPitchedPtr HostArray3D< T >::pitchedPointer() const
{
	return m_pitchedPointer;
}

template< typename T >
DeviceArray3D< T > HostArray3D< T >::deviceArray() const
{
	return DeviceArray3D< T >( m_pitchedPointer, m_width, m_height, m_depth );
}

template< typename T >
void HostArray3D< T >::load( const char* filename )
{
...
template< typename T >
void HostArray3D< T >::save( const char* filename ) const
{
