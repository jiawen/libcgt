...
__inline__ __device__
int libcgt::cuda::threadIndexWithinBlock()
{
	return threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y;
}

__inline__ __device__
int libcgt::cuda::threadIndexGlobal()
{
...
__inline__ __device__
int libcgt::cuda::threadSubscript1DGlobal()
{
	return threadIdx.x + blockIdx.x * blockDim.x;
}

__inline__ __device__
int2 libcgt::cuda::threadSubscript2DGlobal()
{
	return make_int2
	(
...
__inline__ __device__
int3 libcgt::cuda::threadSubscript3DGlobal()
{
	return make_int3
	(
		threadIdx.x + blockIdx.x * blockDim.x,
...
__inline__ __device__
int2 libcgt::cuda::threadSubscript2DWithinBlock()
{
	return make_int2( threadIdx.x, threadIdx.y );
}

__inline__ __device__
int3 libcgt::cuda::threadSubscript3DWithinBlock()
{
