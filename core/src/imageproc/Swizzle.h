...
namespace libcgt { namespace core { namespace imageproc { namespace swizzle {
...
// BGRA source, 4 -> 3.
void BGRAToBGR( Array2DView< const uint8x4 > input, Array2DView< uint8x3 > output );
void BGRAToRGB( Array2DView< const uint8x4 > input, Array2DView< uint8x3 > output );
