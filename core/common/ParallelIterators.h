...
public:
    ...
    template< typename Function >
    static void for2D( const Vector2i& first, const Vector2i& count,
                      const Vector2i& step, const std::string& progressPrefix,
                      const Function& func );
    ...
    template< typename Function >
    static void for3D( const Vector3i& count, const std::string& progressPrefix,
                      const Function& func );
...
// static
template< typename Function >
inline void ParallelIterators::for2D( const Vector2i& count,
                                     const Function& func )
{
...
inline void ParallelIterators::for2D( const Vector2i& count,
                                     ...
                                     const Function& func )
{
    ParallelIterators::for2D( Vector2i{ 0, 0 }, count, Vector2i{ 1, 1 },
                             progressPrefix, func );
}

// static
template< typename Function >
inline void ParallelIterators::for2D( const Vector2i& first,
                                     const Vector2i& count,
                                     const Function& func )
{
...
// static
template< typename Function >
inline void ParallelIterators::for3D( const Vector3i& count,
                                     const std::string& progressPrefix,
                                     const Function& func )
{
    ParallelIterators::for3D( Vector3i{ 0, 0, 0 }, count, Vector3i{ 1, 1, 1 },
                             progressPrefix, func );
}

// static
template< typename Function >
inline void ParallelIterators::for3D( const Vector3i& first,
